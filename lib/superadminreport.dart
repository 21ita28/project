    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(context, MaterialPageRoute(builder:(context)=>SuperAdmin()));// Navigate back to the previous page
          },
        ),
      ),
      body: Padding(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  onPressed:(){
                    Navigator.pushReplacement(context, MaterialPageRoute(builder:(context)=>Supergenerate()));
                  },
                  child: Text('Generate'),
